...
[0] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     TO(1),KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
[1] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      TO(0),KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
[2] = LAYOUT(
  ...
  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_6,    KC_7, blbl   KC_8,    KC_9,    KC_0,  KC_F12,
